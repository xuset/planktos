!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var t;t="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,t.Planktos=e()}}(function(){var e;return function e(t,n,r){function o(s,a){if(!n[s]){if(!t[s]){var u="function"==typeof require&&require;if(!a&&u)return u(s,!0);if(i)return i(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var f=n[s]={exports:{}};t[s][0].call(f.exports,function(e){var n=t[s][1][e];return o(n?n:e)},f,f.exports,e,t,n,r)}return n[s].exports}for(var i="function"==typeof require&&require,s=0;s<r.length;s++)o(r[s]);return o}({1:[function(e,t,n){(function(n,r){function o(e,t,n){function r(){s._close(new Error("IndexedDB database unexpectedly closed"))}function i(e){s._close(e)}var s=this;if("number"!=typeof e)throw new Error("chunkLength must be a number");if("function"==typeof t)return o(e,null,t);if(!(s instanceof o))return new o(e,t,n);t||(t={}),s.chunkLength=e,s.length=Number(t.length)||1/0,s.closed=!1,s._groupPutDelay=t.groupPutDelay||10,s._groupPutCallbacks=[],s._groupPutData={},s._groupPutTimeout=null,s._groupPutInProgress=!1,s._lastGroupPut=0,s.length!==1/0&&(this.lastChunkLength=this.length%this.chunkLength||this.chunkLength,s.lastChunkIndex=Math.ceil(s.length/s.chunkLength)-1);var u=t.name||""+Math.round(9e16*Math.random());t.torrent&&t.torrent.infoHash&&(u=t.torrent.infoHash),s._store=new a(u,n),s._store.on("close",r),s._store.on("error",i)}function i(){null!=arguments[0]&&n.nextTick.apply(this,arguments)}function s(){}t.exports=o;var a=e("idb-kv-store");o.prototype.put=function(e,t,n){var o=this;if(o.closed)throw new Error("Store is closed");if("number"!=typeof e)throw new Error("index must be a number");r.isBuffer(t)||(t=new r(t));var s=e===o.lastChunkIndex,a=s&&t.length!==o.lastChunkLength||!s&&t.length!==o.chunkLength;return a?i(n,new Error("Invalid buffer length")):(o._groupPutData[e]=t,n&&o._groupPutCallbacks.push(n),void o._maybeGroupPut())},o.prototype._maybeGroupPut=function(){var e=this;if(!e.closed&&!e._groupPutInProgress&&0!==Object.keys(e._groupPutData).length){var t=Date.now()-e._lastGroupPut;t>e._groupPutDelay?e._groupPut():null==e._groupPutTimeout&&(e._groupPutTimeout=setTimeout(e._groupPut.bind(e),t))}},o.prototype._groupPut=function(){var e=this;if(!e.closed&&!e._groupPutInProgress){e._groupPutInProgress=!0;var t=e._groupPutCallbacks,n=e._groupPutData;e._groupPutCallbacks=[],e._groupPutData={},null!=e._groupPutTimeout&&clearTimeout(e._groupPutTimeout),e._groupPutTimeout=null;var r=e._store.transaction("readwrite");for(var o in n)r.set(Number(o),n[o],s);r.onfinish=function(n){for(var r in t)t[r](n);e._lastGroupPut=Date.now(),e._groupPutInProgress=!1,e._maybeGroupPut()}}},o.prototype.get=function(e,t,n){var o=this;if("function"==typeof t)return o.get(e,null,t);if("function"!=typeof n)throw new Error("cb must be a function");if(o.closed)throw new Error("Store is closed");if("number"!=typeof e)throw new Error("index must be a number");t||(t={}),o._store.get(e,function(e,o){if(e)return n(e);if("undefined"==typeof o){var i=new Error("Chunk does not exist");return i.name="MissingChunkError",n(i)}var s="offset"in t?t.offset:0,a="length"in t?t.length:o.length-s;n(null,new r(o).slice(s,s+a))})},o.prototype.close=function(e){this._close(),i(e,null)},o.prototype._close=function(e){if(!this.closed){this.closed=!0,this._store.close(),this._store=null,this._groupPutData=null,clearTimeout(this._groupPutTimeout),e=e||new Error("Store is closed");for(var t in this._groupPutCallbacks)this._groupPutCallbacks[t](e);this._groupPutCallbacks=null}},o.prototype.destroy=function(e){var t=this;if(t.closed)throw new Error("Store is closed");t._store.clear(s),t.close(e)}}).call(this,e("_process"),e("buffer").Buffer)},{_process:77,buffer:26,"idb-kv-store":2}],2:[function(e,t,n){function r(e,t,n){function o(e){i(e),m._close(e.target.error),n&&n(e.target.error)}function s(e){i(e),m._close(e.target.error)}function u(e){if(m._closed)e.target.result.close();else{m._db=e.target.result,m._db.onclose=h,m._db.onerror=s;for(var t in m._waiters)m._waiters[t]._init(null);m._waiters=null,n&&n(null),m.emit("open")}}function d(e){var t=e.target.result;t.createObjectStore("kv",{autoIncrement:!0})}function h(){m._close()}function l(e){if("add"===e||"set"===e||"remove"===e)return m._channel?void 0:m.emit("error",new Error("No BroadcastChannel support"))}function p(e){"add"===e.data.method?m.emit("add",e.data):"set"===e.data.method?m.emit("set",e.data):"remove"===e.data.method&&m.emit("remove",e.data)}var m=this;if("string"!=typeof e)throw new Error("A name must be supplied of type string");if(!f)throw new Error("IndexedDB not supported");if("function"==typeof t)return new r(e,null,t);if(!(m instanceof r))return new r(e,t,n);t||(t={}),a.call(m),m._db=null,m._closed=!1,m._channel=null,m._waiters=[];var g=t.channel||c.BroadcastChannel;g&&(m._channel=new g(e),m._channel.onmessage=p);var y=f.open(e);y.onerror=o,y.onsuccess=u,y.onupgradeneeded=d,m.on("newListener",l)}function o(e,t){if(this._kvStore=e,this._mode=t||"readwrite",this._objectStore=null,this._waiters=null,this.finished=!1,this.onfinish=null,"readonly"!==this._mode&&"readwrite"!==this._mode)throw new Error('mode must be either "readonly" or "readwrite"')}function i(e,t){return null==t?i(null,e):(t.preventDefault(),t.stopPropagation(),void(e&&e(t.target.error)))}function s(e){return function(){function t(e,t){if(n)e?o(e):r(t);else if(e)throw e}var n,r,o,i=Array.prototype.slice.call(arguments),s=typeof i[i.length-1];return"function"!==s&&("undefined"===s?i[i.length-1]=t:i[i.length]=t,"undefined"!=typeof Promise&&(n=new Promise(function(e,t){r=e,o=t}))),e.apply(this,i),n}}t.exports=r;var a=e("events").EventEmitter,u=e("inherits"),c="undefined"==typeof window?self:window,f=c.indexedDB||c.mozIndexedDB||c.webkitIndexedDB||c.msIndexedDB;r.INDEXEDDB_SUPPORT=null!=f,r.BROADCAST_SUPPORT=null!=c.BroadcastChannel,u(r,a),r.prototype.get=function(e,t){return this.transaction("readonly").get(e,t)},r.prototype.set=function(e,t,n){return this.transaction("readwrite").set(e,t,n)},r.prototype.json=function(e){return this.transaction("readonly").json(e)},r.prototype.keys=function(e){return this.transaction("readonly").keys(e)},r.prototype.values=function(e){return this.transaction("readonly").values(e)},r.prototype.remove=function(e,t){return this.transaction("readwrite").remove(e,t)},r.prototype.clear=function(e){return this.transaction("readwrite").clear(e)},r.prototype.count=function(e){return this.transaction("readonly").count(e)},r.prototype.add=function(e,t,n){return this.transaction("readwrite").add(e,t,n)},r.prototype.iterator=function(e){return this.transaction("readonly").iterator(e)},r.prototype.transaction=function(e){if(this._closed)throw new Error("Database is closed");var t=new o(this,e);return this._db?t._init(null):this._waiters.push(t),t},r.prototype.close=function(){this._close()},r.prototype._close=function(e){if(!this._closed){this._closed=!0,this._db&&this._db.close(),this._channel&&this._channel.close(),this._db=null,this._channel=null,e&&this.emit("error",e),this.emit("close");for(var t in this._waiters)this._waiters[t]._init(e||new Error("Database is closed"));this._waiters=null,this.removeAllListeners()}},o.prototype._init=function(e){function t(){r._close(null)}function n(e){i(e),r._close(e.target.error)}var r=this;if(!r.finished){if(e)return r._close(e);var o=r._kvStore._db.transaction("kv",r._mode);o.oncomplete=t,o.onerror=n,r._objectStore=o.objectStore("kv");for(var s in r._waiters)r._waiters[s](null,r._objectStore);r._waiters=null}},o.prototype._getObjectStore=function(e){if(this.finished)throw new Error("Transaction is finished");return this._objectStore?e(null,this._objectStore):(this._waiters=this._waiters||[],void this._waiters.push(e))},o.prototype.set=s(function(e,t,n){var r=this;if(null==e||null==t)throw new Error("A key and value must be given");r._getObjectStore(function(o,s){if(o)return n(o);try{var a=s.put(t,e)}catch(e){return n(e)}a.onerror=i.bind(this,n),a.onsuccess=function(){r._kvStore._channel&&r._kvStore._channel.postMessage({method:"set",key:e,value:t}),n(null)}})}),o.prototype.add=s(function(e,t,n){var r=this;if(null==t&&null!=e)return r.add(void 0,e,n);if("function"==typeof t||null==t&&null==n)return r.add(void 0,e,t);if(null==t)throw new Error("A value must be provided as an argument");r._getObjectStore(function(o,s){if(o)return n(o);try{var a=null==e?s.add(t):s.add(t,e)}catch(e){return n(e)}a.onerror=i.bind(this,n),a.onsuccess=function(){r._kvStore._channel&&r._kvStore._channel.postMessage({method:"add",key:e,value:t}),n(null)}})}),o.prototype.get=s(function(e,t){var n=this;if(null==e)throw new Error("A key must be given as an argument");n._getObjectStore(function(n,r){if(n)return t(n);try{var o=r.get(e)}catch(e){return t(e)}o.onerror=i.bind(this,t),o.onsuccess=function(e){t(null,e.target.result)}})}),o.prototype.json=s(function(e){var t=this,n={};t.iterator(function(t,r){return t?e(t):void(r?(n[r.key]=r.value,r.continue()):e(null,n))})}),o.prototype.keys=s(function(e){var t=this,n=[];t.iterator(function(t,r){return t?e(t):void(r?(n.push(r.key),r.continue()):e(null,n))})}),o.prototype.values=s(function(e){var t=this,n=[];t.iterator(function(t,r){return t?e(t):void(r?(n.push(r.value),r.continue()):e(null,n))})}),o.prototype.remove=s(function(e,t){var n=this;if(null==e)throw new Error("A key must be given as an argument");n._getObjectStore(function(r,o){if(r)return t(r);try{var s=o.delete(e)}catch(e){return t(e)}s.onerror=i.bind(this,t),s.onsuccess=function(){n._kvStore._channel&&n._kvStore._channel.postMessage({method:"remove",key:e}),t(null)}})}),o.prototype.clear=s(function(e){var t=this;t._getObjectStore(function(t,n){if(t)return e(t);try{var r=n.clear()}catch(t){return e(t)}r.onerror=i.bind(this,e),r.onsuccess=function(){e(null)}})}),o.prototype.count=s(function(e){var t=this;t._getObjectStore(function(t,n){if(t)return e(t);try{var r=n.count()}catch(t){return e(t)}r.onerror=i.bind(this,e),r.onsuccess=function(t){e(null,t.target.result)}})}),o.prototype.iterator=function(e){var t=this;if("function"!=typeof e)throw new Error("A function must be given");t._getObjectStore(function(t,n){if(t)return e(t);try{var r=n.openCursor()}catch(t){return e(t)}r.onerror=i.bind(this,e),r.onsuccess=function(t){var n=t.target.result;e(null,n)}})},o.prototype.abort=function(){if(this.finished)throw new Error("Transaction is finished");this._objectStore&&this._objectStore.transaction.abort(),this._close(new Error("Transaction aborted"))},o.prototype._close=function(e){if(!this.finished){this.finished=!0,this._kvStore=null,this._objectStore=null;for(var t in this._waiters)this._waiters[t](e||new Error("Transaction is finished"));this.onfinish&&this.onfinish(e),this.onfinish=null,this._waiters=null}}},{events:41,inherits:3}],3:[function(e,t,n){"function"==typeof Object.create?t.exports=function(e,t){e.super_=t,e.prototype=Object.create(t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}})}:t.exports=function(e,t){e.super_=t;var n=function(){};n.prototype=t.prototype,e.prototype=new n,e.prototype.constructor=e}},{}],4:[function(e,t,n){(function(n){function r(e){e=e||{},this._namespace=null!=e.namespace?e.namespace:"",this._snapshots=null,this._snapshotPromise=null,this._snapshotStore=new i("planktos-snapshots-"+this._namespace),this._seeder=null}t.exports=r;const o="undefined"!=typeof window?window:self;o.WorkerGlobalScope&&delete o.FileReaderSync;const i=e("idb-kv-store"),s=e("path"),a=e("parse-torrent-file"),u=e("tab-elect"),c=e("./lib/snapshot"),f=e("./lib/seeder"),d=["/planktos/planktos.min.js","/planktos/install.js"];r.prototype.getFile=function(e){return this.getAllSnapshots().then(t=>{if(0===t.length)throw new Error("No local snapshot. Call planktos.update()");return t[t.length-1].getFile(e)})},r.prototype.fetch=function(e,t){return this.getAllSnapshots().then(n=>{if(0===n.length)throw new Error("No local snapshot. Call planktos.update()");return n[n.length-1].fetch(e,t)})},r.prototype.getAllSnapshots=function(){let e=this;return e._snapshots?Promise.resolve(e._snapshots):e._snapshotPromise?e._snapshotPromise:(e._snapshotPromise=e._snapshotStore.values().then(t=>{e._snapshotPromise=null,e._snapshots=[];for(let n=0;n<t.length;n++)e._snapshots.push(new c(t[n],e._namespace));return e._snapshots}),e._snapshotPromise)},r.prototype.update=function(e){let t=this;e instanceof URL||(e=new URL(e,o.location.origin));let n=new URL(s.join(e.pathname,"planktos/root.torrent"),e),r=new URL(s.join(e.pathname,"planktos/manifest.json"),e),i=d.map(t=>new URL(s.join(e.pathname,t),e));return Promise.all([o.fetch(r).then(e=>e.json()),o.fetch(n).then(e=>e.arrayBuffer()),o.caches.open("planktos-"+t._namespace).then(e=>e.addAll(i))]).then(n=>{let[r,o]=n;return t._add(r,o,e)})},r.prototype._add=function(e,t,r){let o=this;return o.getAllSnapshots().then(()=>{return new Promise(function(i,s){let u=o._snapshotStore.transaction();u.values(function(f,d){if(f)return s(f);let h=a(new n(t)).infoHash,l=o._snapshots.find(e=>e.hash===h);if(l)return l;let p=d.find(e=>e.hash===h),m=null!=p;m||(p={manifest:e,torrentMetaBuffer:t,rootUrl:r.toString(),hash:h}),l=new c(p,o._namespace),o._snapshots.push(l),o._seeder&&o._seeder.add(l),i(m?l:u.add(p).then(()=>l))})})})},r.prototype.removeSnapshot=function(e){let t=this;return t.getAllSnapshots().then(()=>{let n=t._snapshots.findIndex(t=>t.hash===e);return n!==-1&&(t._snapshots[n].destroy(),t._snapshots.splice(n,1),t._seeder&&t._seeder.remove(e)),new Promise(function(n,r){let o=t._snapshotStore.transaction();o.json(function(t,i){if(t)return r(t);let s=Object.keys(i).find(t=>i[t].hash===e);n(null==s?void 0:o.remove(s))})})})},r.prototype.startSeeder=function(){let e=this;if(e._seeder)return e._seeder;e._seeder=new f;let t=new u("planktos");return t.on("elected",e._seeder.start.bind(e._seeder)),t.on("deposed",e._seeder.stop.bind(e._seeder)),e._snapshotStore.on("add",function(t){e._seeder.add(new c(t.value,e._namespace))}),e._snapshotStore.values().then(t=>{t.forEach(t=>e._seeder.add(new c(t,e._namespace)))}),e._seeder}}).call(this,e("buffer").Buffer)},{"./lib/seeder":7,"./lib/snapshot":8,buffer:26,"idb-kv-store":46,"parse-torrent-file":69,path:74,"tab-elect":113}],5:[function(e,t,n){function r(e,t,n){this.path=t,this.hash=n.name,this.length=n.length,this.offset=n.offset,this._snapshot=e,null==this._snapshot._missingChunks&&(this._snapshot._chunkStore._store.on("set",o.bind(null,e)),this._snapshot._missingChunks={})}function o(e,t){if(null!=e._missingChunks[t.key]){let n=e._missingChunks[t.key];delete e._missingChunks[t.key],n.forEach(e=>e())}}t.exports=r;const i=e("chunk-store-read-stream"),s=e("stream-to-blob");r.WEBSTREAM_SUPPORT="undefined"!=typeof ReadableStream,r.prototype.getStream=function(e){e=e||{};let t=e.start||0,n=e.end||this.length-1;if(t<0||n<0||t>this.length-1||n>this.length-1)throw new Error("Range out of bounds");if(0===this.length)throw new Error("Cannot read empty file");return t+=this.offset,n+=this.offset,this._snapshot._priority.add({start:t,end:n}),Promise.resolve(new i(this._snapshot._chunkStore,{start:t,end:n,onmiss:this._onChunkMiss.bind(this)}))},r.prototype.getWebStream=function(e){if(!r.WEBSTREAM_SUPPORT)throw new Error("No web ReadableStream support");return e=e||{},this.getStream(e).then(t=>{function n(e){t.on("data",n=>{e.enqueue(n),t.pause()}),t.on("end",()=>e.close()),t.on("error",t=>e.error(t)),t.pause()}function r(){t.resume()}function o(){t.destroy()}let i=new ReadableStream({start:n,pull:r,cancel:o});return i.length=(e.end||this.length-1)-(e.start||0)+1,i})},r.prototype.getBlob=function(e){return this.getStream(e).then(e=>{return new Promise(function(t,n){s(e,function(e,r){return e?n(e):void t(r)})})})},r.prototype._onChunkMiss=function(e,t,n){"MissingChunkError"===e.name?(this._snapshot._missingChunks[t]=this._snapshot._missingChunks[t]||[],this._snapshot._missingChunks[t].push(n)):n(e)}},{"chunk-store-read-stream":28,"stream-to-blob":110}],6:[function(e,t,n){t.exports.iframe=`<!doctype html>
<html>
<head>
  <meta charset="utf-8">
...
`,t.exports.docWrite=`<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  <script src="{{root}}/planktos/planktos.min.js"></script>
